...
//PennController.GetTable( "SW-datasource-AH-bel.csv" );

PennController.FeedItems( PennController.GetTable( "SW-datasource-AH-bel.csv" ).setLabel("Expt"),//.filter("Expt","experiment"),
    (item) => PennController(
        newTimer("blank", 1000)
            .start()
            .wait()
